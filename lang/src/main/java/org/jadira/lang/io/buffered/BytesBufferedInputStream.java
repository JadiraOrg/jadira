...
/**
 * A BufferedInputStream where the buffer is provided by a NIO ByteBuffer. Use this class as an alternative to {@link java.io.BufferedInputStream}
 */
public class BytesBufferedInputStream extends AbstractBufferedInputStream {
     ...
     */
    public BytesBufferedInputStream(InputStream in) {
     ...
     */
    public BytesBufferedInputStream(InputStream in, int size) {
        super(in, size);
     ...
     * @see java.io.BufferedInputStream#BufferedInputStream(InputStream, int)
     */
    public BytesBufferedInputStream(InputStream in, int size, boolean useNativeByteOrder) {
        this(in, size);
     ...
     * @see java.io.BufferedInputStream#BufferedInputStream(InputStream, int)
     */
    public BytesBufferedInputStream(InputStream in, int size, ByteOrder byteOrder) {
        this(in, size);
        buf.order(byteOrder);
    }
