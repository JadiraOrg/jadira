...
import org.jadira.usertype.dateandtime.threeten.testmodel.OffsetTimeAsTimeAndStringOffsetJdk8;
...
public class TestPersistentOffsetTimeAsTimeAndStringOffset extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < offsetTimes.length; i++) {
            ...
            OffsetTimeAsTimeAndStringOffsetJdk8 item = new OffsetTimeAsTimeAndStringOffsetJdk8();
            item.setId(i);
        ...
        for (int i = 0; i < offsetTimes.length; i++) {
            ...
            OffsetTimeAsTimeAndStringOffsetJdk8 item = manager.find(OffsetTimeAsTimeAndStringOffsetJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, OffsetTimeAsTimeAndStringOffsetJdk8.class.getAnnotation(Table.class).name());
