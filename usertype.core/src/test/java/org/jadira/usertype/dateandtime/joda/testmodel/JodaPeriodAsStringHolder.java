...
@TypeDef(name = "testjoda2_PeriodType", typeClass = PersistentPeriodAsString.class)
public class JodaPeriodAsStringHolder implements Serializable {
    ...
    @Column
    @Type(type = "testjoda2_PeriodType")
