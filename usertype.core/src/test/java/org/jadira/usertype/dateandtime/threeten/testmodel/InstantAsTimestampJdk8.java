...
@TypeDef(name = "test_InstantAsTimestampJdk8Type", typeClass = PersistentInstantAsTimestamp.class)
public class InstantAsTimestampJdk8 implements Serializable {
    ...
    @Column
    @Type(type = "test_InstantAsTimestampJdk8Type")
