...
import org.jadira.usertype.dateandtime.threeten.testmodel.InstantAsMillisLongJdk8;
...
public class TestPersistentInstantAsMillisLong extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < instants.length; i++) {
            ...
            InstantAsMillisLongJdk8 item = manager.find(InstantAsMillisLongJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, InstantAsMillisLongJdk8.class.getAnnotation(Table.class).name());
