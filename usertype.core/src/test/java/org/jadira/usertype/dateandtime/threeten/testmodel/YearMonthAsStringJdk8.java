...
@TypeDef(name = "test_YearMonthAsStringJdk8Jdk8Type", typeClass = PersistentYearMonthAsString.class)
public class YearMonthAsStringJdk8 implements Serializable {
    ...
    @Column
    @Type(type = "test_YearMonthAsStringJdk8Jdk8Type")
