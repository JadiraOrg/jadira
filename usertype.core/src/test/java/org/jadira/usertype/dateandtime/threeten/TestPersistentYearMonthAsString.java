...
import org.jadira.usertype.dateandtime.threeten.testmodel.YearMonthAsStringJdk8;
...
public class TestPersistentYearMonthAsString extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < yearMonths.length; i++) {
            ...
            YearMonthAsStringJdk8 item = new YearMonthAsStringJdk8();
            item.setId(i);
        ...
        for (int i = 0; i < yearMonths.length; i++) {
            ...
            YearMonthAsStringJdk8 item = manager.find(YearMonthAsStringJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, YearMonthAsStringJdk8.class.getAnnotation(Table.class).name());
