...
@TypeDef(name = "test_LocalTimeJdk8Type", typeClass = PersistentLocalTime.class)
public class LocalTimeJdk8 implements Serializable {
    ...
    @Type(type = "test_LocalTimeJdk8Type")
