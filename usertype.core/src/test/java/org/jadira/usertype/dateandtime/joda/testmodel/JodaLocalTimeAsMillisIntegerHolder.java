...
@TypeDef(name = "testjoda_LocalTimeAsMillisIntegerType", typeClass = PersistentLocalTimeAsMillisInteger.class)
public class JodaLocalTimeAsMillisIntegerHolder implements Serializable {
    ...
    @Type(type = "testjoda_LocalTimeAsMillisIntegerType")
