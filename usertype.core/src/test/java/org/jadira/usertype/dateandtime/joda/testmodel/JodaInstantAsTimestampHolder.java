...
@TypeDef(name = "testjoda_InstantAsTimestampType", typeClass = PersistentInstantAsTimestamp.class)
public class JodaInstantAsTimestampHolder implements Serializable {
    ...
    @Column
    @Type(type = "testjoda_InstantAsTimestampType")
