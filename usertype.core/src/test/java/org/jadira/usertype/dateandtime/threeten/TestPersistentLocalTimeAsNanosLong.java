...
import org.jadira.usertype.dateandtime.threeten.testmodel.LocalTimeAsNanosLongJdk8;
...
public class TestPersistentLocalTimeAsNanosLong extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < localTimes.length; i++) {
            ...
            LocalTimeAsNanosLongJdk8 item = new LocalTimeAsNanosLongJdk8();
            item.setId(i);
        ...
        for (int i = 0; i < localTimes.length; i++) {
            ...
            LocalTimeAsNanosLongJdk8 item = manager.find(LocalTimeAsNanosLongJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, LocalTimeAsNanosLongJdk8.class.getAnnotation(Table.class).name());
