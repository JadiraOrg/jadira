...
import org.jadira.usertype.dateandtime.threetenbp.testmodel.YearMonthAsStringBPHolder;
...
public class TestPersistentYearMonthAsString extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < yearMonths.length; i++) {
            ...
            YearMonthAsStringBPHolder item = new YearMonthAsStringBPHolder();
            item.setId(i);
        ...
        for (int i = 0; i < yearMonths.length; i++) {
            ...
            YearMonthAsStringBPHolder item = manager.find(YearMonthAsStringBPHolder.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, YearMonthAsStringBPHolder.class.getAnnotation(Table.class).name());
