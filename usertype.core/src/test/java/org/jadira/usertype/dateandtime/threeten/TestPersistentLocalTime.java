...
import org.jadira.usertype.dateandtime.joda.testmodel.LocalTimeAsTimeJoda;
import org.jadira.usertype.dateandtime.joda.testmodel.TimeOfDayAsTimeJoda;
import org.jadira.usertype.dateandtime.shared.dbunit.DatabaseCapable;
import org.jadira.usertype.dateandtime.threeten.testmodel.LocalTimeJdk8;
...
public class TestPersistentLocalTime extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < localTimes.length; i++) {
            ...
            LocalTimeJdk8 item = new LocalTimeJdk8();
            item.setId(i);
        ...
        for (int i = 0; i < localTimes.length; i++) {
            ...
            LocalTimeJdk8 item = manager.find(LocalTimeJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, LocalTimeJdk8.class.getAnnotation(Table.class).name());
    ...
    public void testRoundtripWithJodaTime() {
        ...
        manager.getTransaction().begin();
        for (int i = 0; i < localTimes.length; i++) {
            manager.remove(manager.find(LocalTimeJdk8.class, Long.valueOf(i)));
        }
        manager.flush();
        manager.getTransaction().commit();
    ...
    public void testNanosWithJodaTimeOfDay() {
        ...
        item = manager.find(LocalTimeJdk8.class, Long.valueOf(1));
