...
@TypeDef(name = "test_LocalDateJdk8Type", typeClass = PersistentLocalDate.class)
public class LocalDateJdk8 implements Serializable {
    ...
    @Column
    @Type(type = "test_LocalDateJdk8Type")
