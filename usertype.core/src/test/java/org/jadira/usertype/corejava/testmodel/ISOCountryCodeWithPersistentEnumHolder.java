...
@TypeDef(name = "ISOCountryCodeWithPersistentEnum", typeClass = PersistentEnum.class)
public class ISOCountryCodeWithPersistentEnumHolder implements Serializable {
    ...
    @Column
    @Type(type = "ISOCountryCodeWithPersistentEnum", parameters = { @Parameter(name="enumClass", value="org.jadira.cdt.country.ISOCountryCode"), @Parameter(name="identifierMethod", value="name"), @Parameter(name="valueOfMethod", value="valueOf") })
