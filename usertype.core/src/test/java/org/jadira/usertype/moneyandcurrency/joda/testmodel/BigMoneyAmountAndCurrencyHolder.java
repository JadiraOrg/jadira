...
@Entity
@Table(name = "bigMoneyAmountAndCurrency")
@TypeDef(name = "testjoda_BigMoneyAmountWithCurrencyType", typeClass = PersistentBigMoneyAmountAndCurrency.class)
public class BigMoneyAmountAndCurrencyHolder implements Serializable {
    ...
    @Type(type = "testjoda_BigMoneyAmountWithCurrencyType")
