...
@Entity
@Table(name = "bigMoneyAmount")
@TypeDef(name = "testjoda_BigMoneyAmountType", typeClass = PersistentBigMoneyAmount.class)
public class BigMoneyAmountHolder implements Serializable {
    ...
    @Column
    @Type(type = "testjoda_BigMoneyAmountType", parameters = { @Parameter(name="currencyCode", value="USD") })
