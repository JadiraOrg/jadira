...
public class TestPersistentMoneyAmountAndCurrencyAsInteger extends AbstractDatabaseTest<MoneyAmountAndCurrencyAsIntegerHolder> {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < moneys.length; i++) {
            ...
            MoneyAmountAndCurrencyAsIntegerHolder item = find((long) i);
