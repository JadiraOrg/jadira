 ...
 */
public class PersistentOffsetTimeAsTimestamp extends AbstractParameterizedTemporalUserType<OffsetTime, Timestamp, TimestampColumnOffsetTimeMapper> implements ParameterizedType, IntegratorConfiguredType {
