...
public class Formatter {
    ...
    public static final DateTimeFormatter LOCAL_TIME_FORMATTER_FOR_PRINTING = new DateTimeFormatterBuilder().appendHourOfDay(2).appendLiteral(':').appendMinuteOfHour(2).appendLiteral(':').appendSecondOfMinute(2)
    ...
    public static final DateTimeFormatter TIMESTAMP_PRINTER = new DateTimeFormatterBuilder().appendPattern("0001-01-01 HH:mm:ss'.'").appendFractionOfSecond(0, 9).toFormatter();
    public static final DateTimeFormatter TIMESTAMP_PARSER = new DateTimeFormatterBuilder().appendPattern("yyyy-MM-dd HH:mm:ss'.'").appendFractionOfSecond(0, 9).toFormatter();
    public static final DateTimeFormatter TIMESTAMP_FORMATTER = TIMESTAMP_PARSER;
}
