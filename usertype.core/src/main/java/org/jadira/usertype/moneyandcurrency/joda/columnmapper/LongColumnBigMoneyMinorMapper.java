...
public class LongColumnBigMoneyMinorMapper extends AbstractLongColumnMapper<BigMoney> implements CurrencyUnitConfiguredColumnMapper<BigMoney, Long> {
    ...
    public BigMoney fromNonNullValue(Long val) {
        return BigMoney.ofMinor(currencyUnit, val);
    }
