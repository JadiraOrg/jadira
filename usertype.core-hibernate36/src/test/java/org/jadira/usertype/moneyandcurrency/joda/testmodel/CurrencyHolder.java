...
@Entity
@Table(name = "currency")
@TypeDef(name = "testjoda_CurrencyType", typeClass = PersistentCurrency.class)
public class CurrencyHolder implements Serializable {
    ...
    @Column
    @Type(type = "testjoda_CurrencyType")
