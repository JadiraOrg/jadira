 ...
 */
public class LocationSafeTimeTypeDescriptor extends TimeTypeDescriptor {
	...
	public <X> ValueBinder<X> getBinder(final JavaTypeDescriptor<X> javaTypeDescriptor) {
		...
		return new BasicBinder<X>(javaTypeDescriptor, this) {
			...
			protected void doBind(PreparedStatement st, X value, int index, WrapperOptions options) throws SQLException {
				st.setTime(index, javaTypeDescriptor.unwrap(value, Time.class, options), getUtcCalendar());
			}
		};
	}
	...
	public <X> ValueExtractor<X> getExtractor( final JavaTypeDescriptor<X> javaTypeDescriptor) {
		...
		return new BasicExtractor<X>(javaTypeDescriptor, this) {
			...
			protected X doExtract(ResultSet rs, String name, WrapperOptions options) throws SQLException {
				return javaTypeDescriptor.wrap(rs.getTime(name, getUtcCalendar()), options);
			}
		};
	}
