...
import org.jadira.usertype.jsr310.columnmapper.StringColumnTimeZoneMapper;
import org.jadira.usertype.jsr310.columnmapper.StringColumnZoneOffsetMapper;
import org.jadira.usertype.jsr310.columnmapper.TimestampColumnLocalDateTimeMapper;
import org.jadira.usertype.jsr310.spi.AbstractMultiColumnUserType;
import org.jadira.usertype.jsr310.spi.ColumnMapper;


/**
 * Persist {@link ZonedDateTime} via Hibernate. The offset will be stored in an extra column.
 */
public class PersistentZonedDateTime extends AbstractMultiColumnUserType<ZonedDateTime> {

    private static final long serialVersionUID = -1335371912886315820L;

    private static final ColumnMapper<?, ?>[] columnMappers = new ColumnMapper<?,?>[] { new TimestampColumnLocalDateTimeMapper(), new StringColumnZoneOffsetMapper(), new StringColumnTimeZoneMapper() };
