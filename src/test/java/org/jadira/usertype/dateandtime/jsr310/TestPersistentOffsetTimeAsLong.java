...
import org.jadira.usertype.dateandtime.jsr310.testmodel.OffsetTimeAsLongHolder;
...
public class TestPersistentOffsetTimeAsLong extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < offsetTimes.length; i++) {
            ...
            OffsetTimeAsLongHolder item = new OffsetTimeAsLongHolder();
            item.setId(i);
        ...
        for (int i = 0; i < offsetTimes.length; i++) {
            ...
            OffsetTimeAsLongHolder item = manager.find(OffsetTimeAsLongHolder.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, OffsetTimeAsLongHolder.class.getAnnotation(Table.class).name());
