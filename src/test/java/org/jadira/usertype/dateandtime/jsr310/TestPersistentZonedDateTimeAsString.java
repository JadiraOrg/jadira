...
import org.jadira.usertype.dateandtime.jsr310.testmodel.ZonedDateTimeAsStringHolder;
...
public class TestPersistentZonedDateTimeAsString extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < zonedDateTimes.length; i++) {
            ...
            ZonedDateTimeAsStringHolder item = new ZonedDateTimeAsStringHolder();
            item.setId(i);
        ...
        for (int i = 0; i < zonedDateTimes.length; i++) {
            ...
            ZonedDateTimeAsStringHolder item = manager.find(ZonedDateTimeAsStringHolder.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, ZonedDateTimeAsStringHolder.class.getAnnotation(Table.class).name());
