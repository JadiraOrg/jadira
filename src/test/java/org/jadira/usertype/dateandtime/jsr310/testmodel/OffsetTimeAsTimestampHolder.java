...
@Entity
@Table(name = "offsetTimeAsTimestamp")
@TypeDef(name = "test_OffsetTimeAsTimestampType", typeClass = PersistentOffsetTimeAsTimestamp.class)
public class OffsetTimeAsTimestampHolder implements Serializable {
    ...
    @Type(type = "test_OffsetTimeAsTimestampType")
