...
import org.jadira.usertype.dateandtime.jsr310.testmodel.OffsetDateTimeHolder;
import org.jadira.usertype.dateandtime.shared.dbunit.DatabaseCapable;
import org.junit.AfterClass;
import org.junit.BeforeClass;
import org.junit.Test;

public class TestPersistentOffsetDateTime extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < offsetDateTimes.length; i++) {
            ...
            OffsetDateTimeHolder item = new OffsetDateTimeHolder();
            item.setId(i);
        ...
        for (int i = 0; i < offsetDateTimes.length; i++) {
            ...
            OffsetDateTimeHolder item = manager.find(OffsetDateTimeHolder.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, OffsetDateTimeHolder.class.getAnnotation(Table.class).name());
