...
import org.jadira.usertype.dateandtime.jsr310.testmodel.OffsetDateHolder;
import org.jadira.usertype.dateandtime.shared.dbunit.DatabaseCapable;
import org.junit.AfterClass;
import org.junit.BeforeClass;
import org.junit.Test;

public class TestPersistentOffsetDate extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < offsetDates.length; i++) {
            ...
            OffsetDateHolder item = new OffsetDateHolder();
            item.setId(i);
        ...
        for (int i = 0; i < offsetDates.length; i++) {
            ...
            OffsetDateHolder item = manager.find(OffsetDateHolder.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, OffsetDateHolder.class.getAnnotation(Table.class).name());
