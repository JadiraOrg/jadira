...
import org.jadira.usertype.dateandtime.jsr310.testmodel.ZonedDateTimeHolder;
...
public class TestPersistentZonedDateTime extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < zonedDateTimes.length; i++) {
            ...
            ZonedDateTimeHolder item = new ZonedDateTimeHolder();
            item.setId(i);
        ...
        for (int i = 0; i < zonedDateTimes.length; i++) {
            ...
            ZonedDateTimeHolder item = manager.find(ZonedDateTimeHolder.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, ZonedDateTimeHolder.class.getAnnotation(Table.class).name());
