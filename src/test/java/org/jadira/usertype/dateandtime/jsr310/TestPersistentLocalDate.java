...
import org.jadira.usertype.dateandtime.jsr310.testmodel.LocalDateHolder;
import org.jadira.usertype.dateandtime.shared.dbunit.DatabaseCapable;
import org.jadira.usertype.dateandtime.shared.testmodel.jodatime.LocalDateJoda;
...
public class TestPersistentLocalDate extends DatabaseCapable {
    ...
    public void testRoundtripWithJodaTime() {
        ...
        manager.getTransaction().begin();
        for (int i = 0; i < localDates.length; i++) {
            manager.remove(manager.find(LocalDateHolder.class, Long.valueOf(i)));
        }
        manager.flush();
        manager.getTransaction().commit();
