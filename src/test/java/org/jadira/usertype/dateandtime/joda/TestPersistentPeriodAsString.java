...
import org.jadira.usertype.dateandtime.shared.testmodel.jodatime.PeriodJoda2;
...
public class TestPersistentPeriodAsString extends DatabaseCapable {
    ...
    public void testRoundtripWithJodaTime() {
        ...
        for (int i = 0; i < periods.length; i++) {
            ...
            PeriodJoda2 item = new PeriodJoda2();
            item.setId(i);
            item.setName("test_" + i);
    ...
    public void testMillisWithJodaTime() {
        ...
        PeriodJoda2 jodaItem = manager.find(PeriodJoda2.class, Long.valueOf(1));
