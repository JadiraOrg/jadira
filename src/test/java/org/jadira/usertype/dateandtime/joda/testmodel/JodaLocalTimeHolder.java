...
@TypeDef(name = "testjoda_LocalTimeType", typeClass = PersistentLocalTime.class)
public class JodaLocalTimeHolder implements Serializable {
    ...
    @Type(type = "testjoda_LocalTimeType")
