 ...
 */
public class PersistentZonedDateTimeAsTimestampStringOffsetAndStringZone extends AbstractMultiColumnUserType<ZonedDateTime> {
    ...
    private static final ColumnMapper<?, ?>[] columnMappers = new ColumnMapper<?, ?>[] { 
        new TimestampColumnLocalDateTimeMapper(), new StringColumnZoneOffsetMapper(), new StringColumnTimeZoneMapper() 
    };
