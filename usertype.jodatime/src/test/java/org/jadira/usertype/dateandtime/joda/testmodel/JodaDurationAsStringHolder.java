...
@TypeDef(name = "testjoda_DurationAsStringType", typeClass = PersistentDurationAsString.class)
public class JodaDurationAsStringHolder implements Serializable {
    ...
    @Column
    @Type(type = "testjoda_DurationAsStringType")
