...
@TypeDef(name = "testjoda_LocalTimeAsTimestampType", typeClass = PersistentLocalTimeAsTimestamp.class)
public class JodaLocalTimeAsTimestampHolder implements Serializable {
