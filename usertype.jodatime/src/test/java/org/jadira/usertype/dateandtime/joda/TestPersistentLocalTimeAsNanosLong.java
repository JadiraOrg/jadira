...
public class TestPersistentLocalTimeAsNanosLong extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < localTimes.length; i++) {
            ...
            JodaLocalTimeAsNanosLongHolder item = manager.find(JodaLocalTimeAsNanosLongHolder.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, JodaLocalTimeAsNanosLongHolder.class.getAnnotation(Table.class).name());
