...
@TypeDef(name = "testjoda_TimeOfDayType", typeClass = PersistentTimeOfDay.class)
@SuppressWarnings("deprecation")
public class TimeOfDayHolder implements Serializable {
    ...
    @Type(type = "testjoda_TimeOfDayType")
