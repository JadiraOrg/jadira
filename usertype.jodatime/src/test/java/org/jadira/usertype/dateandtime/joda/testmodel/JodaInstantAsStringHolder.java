...
@TypeDef(name = "testjoda_InstantAsStringType", typeClass = PersistentInstantAsString.class)
public class JodaInstantAsStringHolder implements Serializable {
    ...
    @Column
    @Type(type = "testjoda_InstantAsStringType")
