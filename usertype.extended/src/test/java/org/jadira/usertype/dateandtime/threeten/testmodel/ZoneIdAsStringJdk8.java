...
@TypeDef(name = "test_ZoneIdAsStringJdk8Type", typeClass = PersistentZoneIdAsString.class)
public class ZoneIdAsStringJdk8 implements Serializable {
    ...
    @Column
    @Type(type = "test_ZoneIdAsStringJdk8Type")
