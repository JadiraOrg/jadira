...
import org.jadira.usertype.dateandtime.threetenbp.testmodel.OffsetDateAsDateAndStringOffsetHolder;
...
public class TestPersistentOffsetDateAsDateAndStringOffset extends DatabaseCapable {
    ...
    private static final OffsetDate[] offsetDates = new OffsetDate[] { OffsetDate.of(LocalDate.of(2004, 2, 25), ZoneOffset.UTC), OffsetDate.of(LocalDate.of(1980, 3, 11), ZoneOffset.UTC) };
