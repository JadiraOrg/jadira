...
import org.jadira.usertype.dateandtime.threeten.testmodel.LocalDateAsStringJdk8;
...
public class TestPersistentLocalDateAsString extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < localDates.length; i++) {
            ...
            LocalDateAsStringJdk8 item = new LocalDateAsStringJdk8();
            item.setId(i);
        ...
        for (int i = 0; i < localDates.length; i++) {
            ...
            LocalDateAsStringJdk8 item = manager.find(LocalDateAsStringJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, LocalDateAsStringJdk8.class.getAnnotation(Table.class).name());
