...
import org.jadira.usertype.dateandtime.threeten.testmodel.LocalTimeAsTimestampJdk8;
...
public class TestPersistentLocalTimeAsTimestamp extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < localTimes.length; i++) {
            ...
            LocalTimeAsTimestampJdk8 item = new LocalTimeAsTimestampJdk8();
            item.setId(i);
        ...
        for (int i = 0; i < localTimes.length; i++) {
            ...
            LocalTimeAsTimestampJdk8 item = manager.find(LocalTimeAsTimestampJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, LocalTimeAsTimestampJdk8.class.getAnnotation(Table.class).name());
