...
@Entity
@Table(name = "monthDay")
@TypeDef(name = "test_MonthDayAsStringJdk8Type", typeClass = PersistentMonthDayAsString.class)
public class MonthDayAsStringJdk8 implements Serializable {
    ...
    @Column
    @Type(type = "test_MonthDayAsStringJdk8Type")
