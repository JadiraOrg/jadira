...
import org.jadira.usertype.dateandtime.threetenbp.testmodel.OffsetTimeAsTimestampAndStringOffset;
...
public class TestPersistentOffsetTimeAsTimestampAndStringOffset extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < offsetTimes.length; i++) {
            ...
            OffsetTimeAsTimestampAndStringOffset item = new OffsetTimeAsTimestampAndStringOffset();
            item.setId(i);
        ...
        for (int i = 0; i < offsetTimes.length; i++) {
            ...
            OffsetTimeAsTimestampAndStringOffset item = manager.find(OffsetTimeAsTimestampAndStringOffset.class, Long.valueOf(i));
