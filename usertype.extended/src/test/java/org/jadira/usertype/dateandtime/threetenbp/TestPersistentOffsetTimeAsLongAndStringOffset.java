...
import org.jadira.usertype.dateandtime.threetenbp.testmodel.OffsetTimeAsLongAndStringOffsetHolder;
...
public class TestPersistentOffsetTimeAsLongAndStringOffset extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < offsetTimes.length; i++) {
            ...
            OffsetTimeAsLongAndStringOffsetHolder item = manager.find(OffsetTimeAsLongAndStringOffsetHolder.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, OffsetTimeAsLongAndStringOffsetHolder.class.getAnnotation(Table.class).name());
