...
import org.jadira.usertype.dateandtime.threeten.testmodel.LocalDateTimeAsStringJdk8;
...
public class TestPersistentLocalDateTimeAsString extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < localDateTimes.length; i++) {
            ...
            LocalDateTimeAsStringJdk8 item = new LocalDateTimeAsStringJdk8();
            item.setId(i);
        ...
        for (int i = 0; i < localDateTimes.length; i++) {
            ...
            LocalDateTimeAsStringJdk8 item = manager.find(LocalDateTimeAsStringJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, LocalDateTimeAsStringJdk8.class.getAnnotation(Table.class).name());
