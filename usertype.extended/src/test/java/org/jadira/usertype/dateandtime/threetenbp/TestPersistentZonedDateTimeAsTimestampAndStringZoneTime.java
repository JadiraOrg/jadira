...
import org.jadira.usertype.dateandtime.threetenbp.testmodel.ZonedDateTimeAsTimestampStringOffsetAndStringZoneHolder;
...
public class TestPersistentZonedDateTimeAsTimestampAndStringZoneTime extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < zonedDateTimes.length; i++) {
            ...
            ZonedDateTimeAsTimestampStringOffsetAndStringZoneHolder item = new ZonedDateTimeAsTimestampStringOffsetAndStringZoneHolder();
            item.setId(i);
        ...
        for (int i = 0; i < zonedDateTimes.length; i++) {
            ...
            ZonedDateTimeAsTimestampStringOffsetAndStringZoneHolder item = manager.find(ZonedDateTimeAsTimestampStringOffsetAndStringZoneHolder.class, Long.valueOf(i));
