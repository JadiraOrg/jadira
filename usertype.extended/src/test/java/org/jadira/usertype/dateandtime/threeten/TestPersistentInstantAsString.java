...
import org.jadira.usertype.dateandtime.threeten.testmodel.InstantAsStringJdk8;
...
public class TestPersistentInstantAsString extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < instants.length; i++) {
            ...
            InstantAsStringJdk8 item = new InstantAsStringJdk8();
            item.setId(i);
        ...
        for (int i = 0; i < instants.length; i++) {
            ...
            InstantAsStringJdk8 item = manager.find(InstantAsStringJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, InstantAsStringJdk8.class.getAnnotation(Table.class).name());
