...
@TypeDef(name = "test_DurationAsStringJdk8Type", typeClass = PersistentDurationAsString.class)
public class DurationAsStringJdk8 implements Serializable {
    ...
    @Column
    @Type(type = "test_DurationAsStringJdk8Type")
