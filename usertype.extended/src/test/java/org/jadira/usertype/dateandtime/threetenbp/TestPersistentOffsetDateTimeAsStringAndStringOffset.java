...
import org.jadira.usertype.dateandtime.threetenbp.testmodel.OffsetDateTimeAsStringAndStringOffsetHolder;
...
public class TestPersistentOffsetDateTimeAsStringAndStringOffset extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < offsetDateTimes.length; i++) {
            ...
            OffsetDateTimeAsStringAndStringOffsetHolder item = new OffsetDateTimeAsStringAndStringOffsetHolder();
            item.setId(i);
        ...
        for (int i = 0; i < offsetDateTimes.length; i++) {
            ...
            OffsetDateTimeAsStringAndStringOffsetHolder item = manager.find(OffsetDateTimeAsStringAndStringOffsetHolder.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, OffsetDateTimeAsStringAndStringOffsetHolder.class.getAnnotation(Table.class).name());
