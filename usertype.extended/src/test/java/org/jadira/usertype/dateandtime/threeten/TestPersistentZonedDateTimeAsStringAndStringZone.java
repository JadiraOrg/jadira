...
import org.jadira.usertype.dateandtime.threeten.testmodel.ZonedDateTimeAsStringAndStringZoneJdk8;
...
public class TestPersistentZonedDateTimeAsStringAndStringZone extends DatabaseCapable {
    ...
    public void testPersist() {
        ...
        for (int i = 0; i < zonedDateTimes.length; i++) {
            ...
            ZonedDateTimeAsStringAndStringZoneJdk8 item = new ZonedDateTimeAsStringAndStringZoneJdk8();
            item.setId(i);
        ...
        for (int i = 0; i < zonedDateTimes.length; i++) {
            ...
            ZonedDateTimeAsStringAndStringZoneJdk8 item = manager.find(ZonedDateTimeAsStringAndStringZoneJdk8.class, Long.valueOf(i));
        ...
        verifyDatabaseTable(manager, ZonedDateTimeAsStringAndStringZoneJdk8.class.getAnnotation(Table.class).name());
