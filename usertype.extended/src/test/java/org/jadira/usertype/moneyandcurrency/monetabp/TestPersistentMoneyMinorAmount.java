...
import org.jadira.usertype.moneyandcurrency.monetabp.testmodel.MoneyMinorAmountHolderBP;
...
public class TestPersistentMoneyMinorAmount extends AbstractDatabaseTest<MoneyMinorAmountHolderBP> {
    ...
    public void testPersist() {
        for (int i = 0; i < moneys.length; i++) {
            MoneyMinorAmountHolderBP item = new MoneyMinorAmountHolderBP();
            item.setId(i);
        ...
        for (int i = 0; i < moneys.length; i++) {
            MoneyMinorAmountHolderBP item = find((long) i);
