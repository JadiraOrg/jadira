...
import org.jadira.usertype.moneyandcurrency.monetabp.testmodel.MoneyMajorAmountHolderBP;
...
public class TestPersistentMoneyMajorAmount extends AbstractDatabaseTest<MoneyMajorAmountHolderBP> {
    ...
    public void testPersist() {
        for (int i = 0; i < moneys.length; i++) {
            MoneyMajorAmountHolderBP item = new MoneyMajorAmountHolderBP();
            item.setId(i);
        ...
        for (int i = 0; i < moneys.length; i++) {
            MoneyMajorAmountHolderBP item = find((long) i);
