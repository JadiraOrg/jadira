...
import org.jadira.usertype.moneyandcurrency.monetabp.testmodel.MoneyAmountHolderBP;
...
public class TestPersistentMoneyAmount extends AbstractDatabaseTest<MoneyAmountHolderBP> {
    ...
    public void testPersist() {
        for (int i = 0; i < moneys.length; i++) {
            MoneyAmountHolderBP item = new MoneyAmountHolderBP();
            item.setId(i);
        ...
        for (int i = 0; i < moneys.length; i++) {
            MoneyAmountHolderBP item = find((long) i);
