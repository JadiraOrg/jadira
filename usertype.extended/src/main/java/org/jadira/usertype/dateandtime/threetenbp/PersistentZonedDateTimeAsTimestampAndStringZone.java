 ...
 */
public class PersistentZonedDateTimeAsTimestampAndStringZone extends AbstractMultiColumnUserType<ZonedDateTime> {
    ...
    protected ZonedDateTime fromConvertedColumns(Object[] convertedColumns) {
        ...
        ZoneId timeZone = (ZoneId) convertedColumns[1];

        return ZonedDateTime.of(datePart, timeZone);
    }
