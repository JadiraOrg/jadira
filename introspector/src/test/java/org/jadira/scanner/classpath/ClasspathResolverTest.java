...
//        assertEquals("JConstructor[name=<init>,enclosingType=JClass[name=org.jadira.scanner.classpath.A],parameters=[JParameter[name=0,type=JClass[name=java.lang.String],enclosingType=JClass[name=org.jadira.scanner.classpath.A]], JParameter[name=1,type=JClass[name=java.lang.Integer],enclosingType=JClass[name=org.jadira.scanner.classpath.A]]]]", constructors.get(0).toString());
...
//        firstClass.toString();
//        
//        JClass secondClass = it.next();
//
//        secondClass.toString();
//        assertEquals("JClass[name=org.jadira.scanner.classpath.ClasspathResolverTest]", secondClass.toString());
//        
//        List<JConstructor> constructors2 = secondClass.getConstructors();
//        assertEquals(1, constructors2.size());
//        assertEquals("JConstructor[name=<init>,enclosingType=JClass[name=org.jadira.scanner.classpath.ClasspathResolverTest],parameters=[]]", constructors2.get(0).toString());
