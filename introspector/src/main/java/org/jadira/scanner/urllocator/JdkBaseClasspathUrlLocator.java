...
import org.jadira.scanner.filenamefilter.JarFilenameFilter;

/**
 * Resolves a list of classpaths representing the core 'rt.jar' and any endorsed
 * @return Array of URLs from the Classpath
 */
public class JdkBaseClasspathUrlLocator implements UrlLocator {
	...
	public URL[] locate() {
        ...
        return classpaths.toArray(new URL[]{});
    }
