 ...
 */
public class PackagesClasspathUrlLocator implements Locator<URL> {

	private List<String> paths;

	private final ClassLoader[] classLoaders;
	   
	public PackagesClasspathUrlLocator(String markerFilePath, ClassLoader... classLoaders) {
    ...
    public PackagesClasspathUrlLocator(List<String> markerFilePaths, ClassLoader... classLoaders) {
