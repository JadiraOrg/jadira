 ...
 */
public class ContainedClassClasspathUrlLocator implements Locator<URL> {
	...
	public ContainedClassClasspathUrlLocator(List<Class<?>> classes, ClassLoader... classLoaders) {
        this.paths = new ArrayList<String>(classes.size());
    ...
    private static String asNormalizedName(Class<?> clazz) {
        ...
        String result = clazz.getName().replace(".", "/") + ".class";
        return result;
    }
}
