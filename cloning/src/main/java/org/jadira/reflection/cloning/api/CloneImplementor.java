...
public interface CloneImplementor {
	 ...
	 * @param <T> The type of the instance to be constructed
	 ...
	 * @param stackDepth The number of objects already cloned in the current data structure
	 * @param <T> The type of the object to be cloned
	 * @return The cloned object
	 */
	<T> T clone(T obj, CloneDriver context, IdentityHashMap<Object, Object> referencesToReuse, long stackDepth);
}
