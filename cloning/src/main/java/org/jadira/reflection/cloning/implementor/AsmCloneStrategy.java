...
import org.jadira.reflection.access.asm.AsmClassAccess;
 ...
 */
public class AsmCloneStrategy extends AbstractCloneStrategy implements CloneStrategy {
	...
	public <T> T newInstance(Class<T> c) {
		...
		ClassAccess<T> classAccess = AsmClassAccess.get(c);
		return classAccess.newInstance();
	}

	private static AsmCloneStrategy instance = new AsmCloneStrategy();
