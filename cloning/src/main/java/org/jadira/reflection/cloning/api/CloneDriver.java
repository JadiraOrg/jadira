...
public interface CloneDriver extends CloneImplementor {
	 ...
	 * @param clazz The class
	 * @param implementor Implementor to register
	 */
	 ...
	 * @param instance The instance to check for whether it is registered as immutable
	 * @return True if the object is registered as immutable
	 */
	boolean isImmutableInstance(Object instance);
	
	/** 
	 * Stores an object instance to be treated as immutable
	 * @param instance Object to be considered immutable
	 */
	void putImmutableInstance(Object instance);
	
	/**
	 * Indicates whether to track references
	 * @return trackReferences Default is true
	 */
    boolean isTrackReferences();
	
	/**
	 * Indicates whether to also track references for flat classes when tracking references.
	 * @return trackReferences Default is false
	 */
